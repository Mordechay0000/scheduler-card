...
/**
          ...
          <div class="content-inner">
            ...
            <div class="bar">
              ...
              ${void 0!==this.now?q`
                <div
                  class="now-line"
                  style=${Gs({insetInlineStart:(3600*this.now.getHours()+60*this.now.getMinutes()+this.now.getSeconds())/86400*this._contentWidth+"px"})}
                ></div>
              `:""}
              ${this._createRange?q`
                <div
    ...
    `}};t([le({attribute:!1})],No.prototype,"hass",void 0),t([le({attribute:!1})],No.prototype,"action",void 0),t([le()],No.prototype,"entityId",void 0),No=t([re("scheduler-overview-action-panel")],No);let Io=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this.editable=!0,this.spanDays=1,this._saveState=null,this._selectedSlot=null,this._undoStack=[]}render(){var e,t,i;try{const s=this.hass.states[this.schedule.entity_id];if(!s)return q``;const a=["off","completed"].includes(s.state),{entry:o,index:n}=Eo(this.schedule.entries,this.date),r=this.date||new Date,d=To(o,r),l=new Date(r.getTime()+864e5),c=2===this.spanDays?Eo(this.schedule.entries,l):null,h=!!c&&To(c.entry,l),u=2===this.spanDays?Math.max(0,(this.viewportWidth-6)/2):this.viewportWidth,p=null===(e=o.slots.find(e=>e.actions.length))||void 0===e?void 0:e.actions[0];let m="mdi:calendar-clock";if(p){let e=[(null===(t=p.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Qi(p.service))&&(e=p.service),e&&(m=na(e,this.config.customize,this.hass))}const _=p?As(["script","notify"].includes(Qi(p.service))?p.service:[(null===(i=p.target)||void 0===i?void 0:i.entity_id)||[]].flat()[0]||"",this.hass,this.config.customize):this.schedule.name||this.schedule.entity_id;return q`
        <div class="row ${a?"disabled":""} ${d?"":"not-today"}">
          <div class="device">
            ...
            <ha-icon-button
              ...
              .label=${Ki("ui.panel.overview.duplicate",this.hass)}
              title=${Ki("ui.panel.overview.duplicate",this.hass)}
    ...
    `}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".ruler");t&&(t.style.direction=getComputedStyle(this).direction)}};t([le({attribute:!1})],qo.prototype,"hass",void 0),t([le({attribute:!1})],qo.prototype,"now",void 0),t([le({type:Number})],qo.prototype,"zoom",void 0),t([le({type:Number})],qo.prototype,"panPx",void 0),t([le({type:Number})],qo.prototype,"minZoom",void 0),t([le({type:Number})],qo.prototype,"maxZoom",void 0),t([le({type:Number})],qo.prototype,"spanDays",void 0),t([le({attribute:!1})],qo.prototype,"dayLabels",void 0),t([ce()],qo.prototype,"_width",void 0),qo=t([re("scheduler-overview-ruler")],qo);const Ro=()=>({type:ge.Or,items:[],track_changes:!1}),Vo=e=>({service:Qi(e)+".turn_on",service_data:{},target:{entity_id:e}}),Uo=e=>({service:Qi(e)+".turn_off",service_data:{},target:{entity_id:e}});let Ho=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this.editable=!0,this._picking=!1,this._entityId=null,this._slots=[],this._selectedSlot=null,this._saving=!1}_reset(){this._picking=!1,this._entityId=null,this._slots=[],this._selectedSlot=null}_startPicking(){this._picking=!0}_handleEntityPicked(e){var t;const i=null===(t=e.detail)||void 0===t?void 0:t.value,s=Array.isArray(i)?i[i.length-1]:i;s&&(this._entityId=s,this._picking=!1,this._slots=[{start:"00:00:00",stop:"08:00:00",actions:[Uo(s)],conditions:Ro()},{start:"08:00:00",stop:"16:00:00",actions:[Vo(s)],conditions:Ro()},{start:"16:00:00",stop:"00:00:00",actions:[Uo(s)],conditions:Ro()}],this._selectedSlot=null)}_handleSlotsChanged(e){e.stopPropagation(),this._slots=e.detail.slots}_handleSlotSelected(e){e.stopPropagation(),this._selectedSlot=e.detail.index}_handleActionChanged(e){const t=this._selectedSlot;null!==t&&(this._slots=Object.assign([...this._slots],{[t]:Object.assign(Object.assign({},this._slots[t]),{actions:[e.detail.action]})}))}async _save(){if(!this._slots.length)return;this._saving=!0;const e={entries:[{weekdays:[_e.Daily],slots:this._slots}],repeat_type:be.Repeat,next_entries:[],timestamps:[],enabled:!0};try{await $a(this.hass,e),this._reset()}finally{this._saving=!1}}render(){var e,t;if(!this.hass)return q``;const i=this._selectedSlot;return q`
      <div class="row">
        <div class="device">
    ...
    `}};t([le({attribute:!1})],Ho.prototype,"hass",void 0),t([le({attribute:!1})],Ho.prototype,"config",void 0),t([le({type:Number})],Ho.prototype,"zoom",void 0),t([le({type:Number})],Ho.prototype,"panPx",void 0),t([le({type:Number})],Ho.prototype,"viewportWidth",void 0),t([le({type:Boolean})],Ho.prototype,"editable",void 0),t([ce()],Ho.prototype,"_picking",void 0),t([ce()],Ho.prototype,"_entityId",void 0),t([ce()],Ho.prototype,"_slots",void 0),t([ce()],Ho.prototype,"_selectedSlot",void 0),t([ce()],Ho.prototype,"_saving",void 0),Ho=t([re("scheduler-overview-add-row")],Ho);let Fo=class extends oe{constructor(){super(...arguments),this.date=new Date,this.spanDays=1}_select(e){this.dispatchEvent(new CustomEvent("date-changed",{detail:{date:e},bubbles:!0,composed:!0}))}_toggleSpan(){this.dispatchEvent(new CustomEvent("span-changed",{detail:{spanDays:2===this.spanDays?1:2},bubbles:!0,composed:!0}))}render(){if(!this.hass)return q``;const e=new Date;e.setHours(0,0,0,0);const t=Array.from({length:7},(t,i)=>new Date(e.getTime()+864e5*i)),i=new Date(this.date);return i.setHours(0,0,0,0),q`
      <div class="daybar">
        <div class="days">
          ${t.map(t=>{var s;const a=t.getTime()===i.getTime(),o=t.getTime()===e.getTime(),n=o?Ki("ui.panel.overview.today",this.hass):t.toLocaleDateString((null===(s=this.hass.locale)||void 0===s?void 0:s.language)||void 0,{weekday:"short"});return q`
              <button
                class="day ${a?"selected":""} ${o?"today":""}"
                @click=${()=>this._select(t)}
              >${n}</button>
            `})}
        </div>
        <button class="span ${2===this.spanDays?"active":""}" @click=${this._toggleSpan}>
          ${Ki("ui.panel.overview.two_days",this.hass)}
        </button>
      </div>
    `}static get styles(){return r`
      :host { display: block; }

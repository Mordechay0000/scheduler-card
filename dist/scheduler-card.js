...
/**
    ...
    `}renderIcon(){if(!this.icon&&!this.toggleable&&!this.useStateIcon)return V;if(this.toggleable)return q`
      ...
      `:q`
        <div class="trailing-icon" @click=${this._iconClick}>
          ...
          ${this.disabled?V:q`<ha-tooltip for="${e}">${ss("ui.common.remove",this.hass)}</ha-tooltip>`}
        </div>
    ...
    `}};t([le({attribute:!1})],ca.prototype,"hass",void 0),t([le({type:String})],ca.prototype,"icon",void 0),t([le({type:Boolean})],ca.prototype,"useStateIcon",void 0),t([le({type:Boolean})],ca.prototype,"selectable",void 0),t([le({type:Boolean})],ca.prototype,"removable",void 0),t([le({type:Boolean})],ca.prototype,"toggleable",void 0),t([le({type:Boolean})],ca.prototype,"active",void 0),t([le({type:String})],ca.prototype,"badge",void 0),t([le({type:String})],ca.prototype,"value",void 0),t([le({type:Boolean})],ca.prototype,"disabled",void 0),ca=t([re("scheduler-chip")],ca);let ha=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
  ...
  `,t([le({attribute:!1})],pa.prototype,"hass",void 0),t([le()],pa.prototype,"domain",void 0),t([le()],pa.prototype,"config",void 0),t([le({type:Array})],pa.prototype,"value",void 0),t([le({type:Boolean})],pa.prototype,"multiple",void 0),t([le({type:Boolean})],pa.prototype,"disabled",void 0),t([ce()],pa.prototype,"multipleMode",void 0),t([ce()],pa.prototype,"scheduleEntities",void 0),pa=t([re("scheduler-entity-picker")],pa);let ma=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return q`
    ...
    `}};t([le()],_a.prototype,"disabled",void 0),t([ce()],_a.prototype,"_openedItem",void 0),t([ce()],_a.prototype,"_numItems",void 0),_a=t([re("scheduler-collapsible-group")],_a);const ga="__NONE_OPTION__";let va=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),Ps(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return q`
        ...
        `)},l=e=>{let t=e.target,i=t.querySelector("ha-picker-field");this.style.setProperty("--select-menu-width",i.offsetWidth+"px"),t.classList.add("opened")},c=e=>{e.target.classList.remove("opened")},h=e=>{const t=e.detail.item.value;(t!=ga&&!Array.isArray(this.value)||(e.target.value=void 0,t!=ga))&&this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))},u=()=>{this._valueChanged(new CustomEvent("value-changed",{detail:{value:void 0}}))},p=Ue(this.value)&&!Array.isArray(this.value)?n.find(e=>e.id===this.value):void 0,m=p?p.primary||p.id:Ue(this.value)&&!Array.isArray(this.value)?this.value:void 0;return q`
        <div class="select-wrapper">
          ...
          >
            <ha-picker-field
              ...
              @clear=${u}
              .disabled=${this.disabled}
              .hideClearIcon=${this.disabled||!Ue(this.value)||Array.isArray(this.value)&&!this.value.length}
              .value=${m}
      ...
      `}if(this.config.number){const t=this.config.number,i="box"==t.mode||!Ue(t.min)||!Ue(t.max);let s=this.value;i||"number"==typeof s||(s=t.min),"number"==typeof t.scale_factor&&(s=Number(s)/t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(s=Math.round(Number(s)/t.step)*t.step),Ue(s)&&(s=hs(Number(s)));const a=e=>{let i=Number(e.target.value);"number"==typeof t.scale_factor&&(i*=t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(i=Math.round(i/t.step)*t.step),i=hs(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}})),e.stopPropagation()},o=e=>{e.stopPropagation();let t=e.target.value;const i=""===t||isNaN(Number(t))?void 0:Number(t);this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))},n=(e,i)=>{let s=t.step&&Number(t.step)%1==0?null!==e.match(/^-?\d+$/):null!==e.match(/^[+-]?\d+([.,]\d+)?$/);return s&&Ue(t.min)&&(s=Number(e)>=t.min),s&&Ue(t.max)&&(s=Number(e)<=t.max),{valid:s,customError:!s}};return q`
      ...
      `}return q``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t]}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;Ps(this,"value-changed",{value:this.value})}};va.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
        ...
        <div class="column">
          <ha-formfield label="${Ki("ui.panel.card_editor.fields.display_format_secondary.options.relative_time",this.hass)}">
            <ha-checkbox
              ...
              ?checked=${[(null===(a=this._config.display_options)||void 0===a?void 0:a.secondary_info)||Re].flat().includes("relative-time")}
            >
            </ha-checkbox>
          </ha-formfield>
          ...
          <ha-formfield label="${Ki("ui.panel.card_editor.fields.display_format_secondary.options.time",this.hass)}">
            <ha-checkbox
              value="time"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(o=this._config.display_options)||void 0===o?void 0:o.secondary_info)||Re].flat().includes("time")}
            >
            </ha-checkbox>
          </ha-formfield>
        ...
        <div class="column">
          <ha-formfield label="${Ki("ui.panel.card_editor.fields.display_format_secondary.options.days",this.hass)}">
            <ha-checkbox
              value="days"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(n=this._config.display_options)||void 0===n?void 0:n.secondary_info)||Re].flat().includes("days")}
            >
            </ha-checkbox>
          </ha-formfield>
          ...
          <ha-formfield label="${Ki("ui.panel.card_editor.fields.display_format_secondary.options.additional_tasks",this.hass)}">
            <ha-checkbox
              ...
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(r=this._config.display_options)||void 0===r?void 0:r.secondary_info)||Re].flat().includes("additional-tasks")}
            >
            </ha-checkbox>
          </ha-formfield>
        </div>
...
`,(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=cs(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const d=r.fields[t];if(null===_s(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(d.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&d.supported_features)>0}))return!1}return!("light"==Yi(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"==t?s.filter(e=>"onoff"!=e).length:"color_temp_kelvin"!=t||s.includes("color_temp")}))});var wa;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(wa||(wa={}));const ka=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>e.every((i,s)=>{const a=Ee(i.start,t),o=void 0===i.stop?a:Ee(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>{if(i<=s)return!0;return Ee(e.start,t)>=o})})?null:wa.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,wa.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=cs(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?wa.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>ba(e,s,t,i)).every(([s,a])=>{var o,n;let r=_s(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const d=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!d)&&!(!Ue(e.service_data[s])&&!d)})?wa.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},xa=(e,t)=>{const i=$a(t);return e.callApi("POST","scheduler/add",i)},$a=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(ja),timeslots:e.entries[0].slots.map(Sa),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},ja=e=>{switch(e){case me.Monday:return"mon";case me.Tuesday:return"tue";case me.Wednesday:return"wed";case me.Thursday:return"thu";case me.Friday:return"fri";case me.Saturday:return"sat";case me.Sunday:return"sun";case me.Workday:return"workday";case me.Weekend:return"weekend";default:return"daily"}},Sa=e=>({start:e.start,stop:e.stop,actions:e.actions.map(e=>Oa(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==_e.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),Oa=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>Ue(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:s(e.service_data),entity_id:t}))}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},za=(e,t,i)=>{const s={title:ss("state_badge.default.error",i),description:q`
  ...
  `,primaryButtonLabel:ss("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};Ps(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return vo})),dialogParams:s})},Ca=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},Ea=e=>JSON.stringify(Object.fromEntries(Object.entries(e||{}).sort(([e],[t])=>e.localeCompare(t)))),Aa=(e,t)=>e.length===t.length&&e.every((e,i)=>{const s=t[i];return e.service===s.service&&Ea(e.service_data)===Ea(s.service_data)&&Ea(e.target)===Ea(s.target)}),Ta=e=>{const t=[];for(const i of e){const e=t[t.length-1];e&&void 0!==e.stop&&Aa(e.actions,i.actions)&&JSON.stringify(e.conditions)===JSON.stringify(i.conditions)?t[t.length-1]=Object.assign(Object.assign({},e),{stop:i.stop}):t.push(i)}return t},Da=(e,t)=>{const i=cs(e,t),s=Yi(e.service),a=Xi(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;if(Object.keys(ms).includes(s)&&Object.keys(ms[s].services).includes(a)){if(void 0!==ms[s].attributes){let t=ms[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return ms[s].services[a]}return Object.keys(ms).includes(s)&&Object.keys(ms[s].services).includes("{entity_id}")?ms[s].services["{entity_id}"]:"mdi:flash";var o},Ma=e=>{var t;return"turn_off"===Xi(e.service)||"off"===(null===(t=e.service_data)||void 0===t?void 0:t.state)},Pa=e=>{var t;return"turn_on"===Xi(e.service)||"on"===(null===(t=e.service_data)||void 0===t?void 0:t.state)},La=e=>{const t=Xi(e.service);if("turn_on"!==t&&"turn_off"!==t)return null;const i=e.service.split(".")[0];return Object.assign({service:`${i}.${"turn_on"===t?"turn_off":"turn_on"}`,service_data:{}},e.target?{target:e.target}:{})},Na=(e,t,i)=>{let s=Ee("string"==typeof e?Ce(e):e,i),a=Ee("string"==typeof t?Ce(t):t,i);return a>s?1:a<s?-1:0},Ia=e=>Ce(e.start),qa=e=>{if(Ue(e.stop)){const t=Ce(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==be.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return Oe(Ia(e),{minutes:1})},Ra=(e,t,i,s)=>{let a=t;if(Ue(i.stop))return[e,a]=Ra(e,t+1,{start:i.stop},s),[e,a-1];if(!Ue(i.start))return[e,a];let o=Ia(e[t]),n=i.start,r=Ia(e[t]);for(let i=t-1;i>=0;i--){if(e[i].actions.length){r=i==t-1?Oe(Ia(e[i]),{minutes:1}):qa(e[i]);break}r=Ia(e[i])}let d=Oe(qa(e[t]),{minutes:-1});if(!Ue(e[t].stop))for(let i=t+1;i<e.length;i++){if(e[i].actions.length){d=i==t+1?Oe(qa(e[i]),{minutes:-1}):Ia(e[i]);break}d=qa(e[i])}if(Na(r,n,s)<0&&(n=r),Na(d,n,s)>0&&Ee(d,s)>0&&(n=d),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Ne(n)})}),Na(o,n,s)<=0)for(let i=t-1;i>=0;i--){let t=Na(Ia(e[i]),n,s),o=Na(qa(e[i]),n,s);if(t>0&&o<=0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:Ne(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}if(Na(o,n,s)<0&&!Ue(e[t].stop)&&(e=Ue(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:Ne(qa(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:Ne(qa(e[t])),stop:Ne(Ia(e[t+1])),actions:[]}),...e.slice(t+1)]),Na(o,n,s)>=0)for(let t=a+1;t<e.length;t++){let i=qa(e[a]),o=Na(Ia(e[t]),i,s),n=Na(qa(e[t]),i,s);if(o>=0&&n<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Ne(i)})});else{if(o<0)break;n>=0&&(e=Object.assign(e,{[t]:null}))}}return Na(o,n,s)>0&&(t>0&&Ue(e[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:Ne(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:t>0?Ne(qa(e[t-1])):"00:00:00",stop:Ne(n),actions:[]}),...e.slice(t)],a=t+1)),[e=e.filter(Ue),a]},Va=e=>{const t=Math.floor(e/3600),i=Math.round((e-3600*t)/60),s={mode:be.Fixed,hours:t,minutes:i};return Ne(s)},Fa=[67,160,71],Ha=e=>{if(!Pa(e))return null;const t=e.service_data||{};let i;var s;let a;if("number"==typeof t.color_temp_kelvin?i=t.color_temp_kelvin:"number"==typeof t.color_temp&&(s=t.color_temp,i=Math.round(1e6/s)),"number"==typeof t.brightness?a=t.brightness/255*100:"number"==typeof t.brightness_pct&&(a=t.brightness_pct),void 0===i&&void 0===a)return null;return{rgb:void 0!==i?(e=>{const t=Math.min(Math.max(e,1e3),12e3)/100;let i,s,a;t<=66?(i=255,s=99.4708025861*Math.log(t)-161.1195681661,a=t<=19?0:138.5177312231*Math.log(t-10)-305.0447927307):(i=329.698727446*Math.pow(t-60,-.1332047592),s=288.1221695283*Math.pow(t-60,-.0755148492),a=255);const o=e=>Math.round(Math.min(Math.max(e,0),255));return[o(i),o(s),o(a)]})(i):Fa,alpha:void 0!==a?.25+.6*Math.min(Math.max(a,0),100)/100:.75}},Wa=(e,t)=>{if(!e)return[];const i=[1,2,3,4,6,8,12],s=t?88:56;let a=Math.ceil(24/(e/s));for(;!i.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let i=a/24*100;return i=Math.floor(100*i)/100,0!==t&&t!==o.length-1||(i/=2),{hour:e,widthPct:i,align:0===t?"left":t===o.length-1?"right":"center"}})},Ua=(e,t,i,s=3,a=5)=>{const o=i-(e.length-1)*s,n=e.map((i,s)=>{const a=Ee(i.start,t);let o;if(void 0!==i.stop)o=Ee(i.stop,t),!o&&a&&(o=86400);else{const i=e[s+1];o=i&&Ee(i.start,t)||86400}return(o-a)/86400}),r=a/o,d=o-n.filter(e=>e<r).length*a;return n.map(e=>e<r?a:e*d)},Ba=(e,t,i,s=3,a=null)=>{const o=t=>null!==a&&e[a]===t?"pending":t.actions.length?Ma(t.actions[0])?"off":Pa(t.actions[0])?"on":"":"empty",n=e=>{const t=e.actions.length?Ha(e.actions[0]):null;return t?`rgba(${t.rgb.join(", ")}, ${t.alpha})`:void 0},r=[];let d=0;e.forEach((a,l)=>{0===l&&r.push({position:d,label:Ne(Ce(a.start),{seconds:!1,am_pm:i}),align:"start",state:o(a),color:n(a)});const c=d+t[l],h=l===e.length-1;void 0!==a.stop&&r.push({position:c,label:Ne(Ce(a.stop),{seconds:!1,am_pm:i}),align:h?"end":"middle",state:o(h?a:e[l+1]),color:n(h?a:e[l+1])}),d=c+(h?0:s)});const l=[],c=r.map(e=>{const t=7*e.label.length+6;const i="end"===e.align?e.position-t:e.position-t/2,s="start"===e.align?e.position+t:e.position+t/2;let a=l.findIndex(e=>i>e);return-1===a&&(a=l.length),l[a]=s,a}),h=c.reduce((e,t)=>Math.max(e,t),0);return{boundaries:r.map((e,t)=>Object.assign(Object.assign({},e),{tier:c[t]})),maxTier:h}},Za=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),ze({hours:n,minutes:r})},Ka=(e,t)=>{const i=Math.floor(e/3600),s=Math.round((e-3600*i)/60);return Ne({mode:be.Fixed,hours:i,minutes:s},{seconds:!1,am_pm:t})};let Xa=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this._width=0,this._zoom=1,this._panPx=0,this.pendingSlot=null,this._suppressNextClick=!1,this._undoStack=[],this.large=!1,this._handleKeyDown=e=>{const t=e.composedPath()[0],i=t instanceof HTMLElement&&(["input","textarea","select"].includes(t.tagName.toLowerCase())||t.isContentEditable);if("z"===e.key.toLowerCase()&&(e.ctrlKey||e.metaKey)&&!e.shiftKey&&!i)return e.preventDefault(),void this._undo();if("Delete"!==e.key&&"Backspace"!==e.key)return;if(null===this.selectedSlot||!this.schedule)return;if(i)return;if(null!==this.pendingSlot&&this.selectedSlot===this.pendingSlot)return e.preventDefault(),this._revertPendingSlot(null),this.selectedSlot=null,void this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:null}}));const s=this.schedule.slots;if(s.length<=2)return;e.preventDefault(),this._pushUndo();const a=this.selectedSlot,o=a===s.length-1?a-1:a;let n=[...s.slice(0,o),Object.assign(Object.assign({},s[o+1]),{start:s[o].start,stop:s[o+1].stop}),...s.slice(o+2)];n=Ta(n),this.schedule=Object.assign(Object.assign({},this.schedule),{slots:n}),this.selectedSlot=null,this.dispatchEvent(new CustomEvent("update",{detail:{slots:n}})),this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:null}}))}}_pushUndo(){this.schedule&&this._undoStack.push(this.schedule.slots),this._undoStack.length>50&&this._undoStack.shift()}_undo(){const e=this._undoStack.pop();e&&this.schedule&&(this.schedule=Object.assign(Object.assign({},this.schedule),{slots:e}),this.pendingSlot=null,this._slotsBackup=void 0,this.dispatchEvent(new CustomEvent("update",{detail:{slots:e}})))}get _contentWidth(){return this._width*this._zoom}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e!==this._width&&(this._width=e,this._panPx=this._clampPan(this._panPx,this._zoom))}}),this._resizeObserver.observe(this),window.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._resizeObserver)||void 0===e||e.disconnect(),this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame),window.removeEventListener("keydown",this._handleKeyDown)}_clampPan(e,t){const i=Math.max(0,this._width*t-this._width);return Math.min(Math.max(e,0),i)}_setZoom(e,t){const i=Math.min(Math.max(e,1),48),s=this._width*this._zoom,a=this._panPx+t,o=(s>0?a/s:0)*(this._width*i)-t;this._zoom=i,this._panPx=this._clampPan(o,i)}_animateZoomBy(e,t){this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame);const i=this._zoom,s=Math.min(Math.max(i*e,1),48),a=performance.now(),o=e=>{const n=Math.min((e-a)/220,1),r=1-Math.pow(1-n,3),d=i+(s-i)*r;this._setZoom(d,t),this._zoomAnimationFrame=n<1?requestAnimationFrame(o):void 0};this._zoomAnimationFrame=requestAnimationFrame(o)}_handleZoomInClick(){this._animateZoomBy(1.6,this._width/2)}_handleZoomOutClick(){this._animateZoomBy(.625,this._width/2)}_handleZoomResetClick(){this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame);const e=this._zoom,t=this._panPx,i=performance.now(),s=a=>{const o=Math.min((a-i)/220,1),n=1-Math.pow(1-o,3);this._zoom=e+(1-e)*n,this._panPx=t+(0-t)*n,this._zoomAnimationFrame=o<1?requestAnimationFrame(s):void 0};this._zoomAnimationFrame=requestAnimationFrame(s)}_handleWheel(e){if(!this._width)return;const t=e.ctrlKey||e.metaKey||Math.abs(e.deltaY)>=Math.abs(e.deltaX);e.preventDefault();const i=e.currentTarget.getBoundingClientRect(),s=e.clientX-i.left;if(t){this._zoomAnimationFrame&&(cancelAnimationFrame(this._zoomAnimationFrame),this._zoomAnimationFrame=void 0);const t=Math.pow(2,-e.deltaY/300);this._setZoom(this._zoom*t,s)}else this._panPx=this._clampPan(this._panPx+e.deltaX,this._zoom)}_handleRulerPanStart(e){this._zoom<=1||(e.currentTarget.setPointerCapture(e.pointerId),this._panDrag={pointerId:e.pointerId,startX:e.clientX,startPanPx:this._panPx})}_handleRulerPanMove(e){if(!this._panDrag||this._panDrag.pointerId!==e.pointerId)return;const t=e.clientX-this._panDrag.startX;this._panPx=this._clampPan(this._panDrag.startPanPx-t,this._zoom)}_handleRulerPanEnd(){this._panDrag=void 0}_touchDistance(e){const t=e[0].clientX-e[1].clientX,i=e[0].clientY-e[1].clientY;return Math.hypot(t,i)}_handlePinchStart(e){if(2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect(),i=(e.touches[0].clientX+e.touches[1].clientX)/2-t.left;this._pinch={distance:this._touchDistance(e.touches),midpointX:i,panPx:this._panPx,zoom:this._zoom}}_handlePinchMove(e){if(!this._pinch||2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect(),i=(e.touches[0].clientX+e.touches[1].clientX)/2-t.left,s=this._touchDistance(e.touches)/this._pinch.distance,a=Math.min(Math.max(this._pinch.zoom*s,1),48),o=this._width*this._pinch.zoom,n=this._pinch.panPx+this._pinch.midpointX,r=(o>0?n/o:0)*(this._width*a)-i,d=-(i-this._pinch.midpointX);this._zoom=a,this._panPx=this._clampPan(r+d,a)}_handlePinchEnd(e){e.touches.length<2&&(this._pinch=void 0)}get _dragStepSize(){return this._zoom>=4?1:this.config.time_step||15}_clientXToTs(e,t=!0){const i=this.shadowRoot.querySelector(".bar").getBoundingClientRect();let s="rtl"===getComputedStyle(this).direction?i.right-e:e-i.left;s<0&&(s=0),s>i.width&&(s=i.width);let a=Math.round(s/i.width*86400);if(t){const e=60*this._dragStepSize;a=Math.round(a/e)*e}return a}_handleCreateDragStart(e){if(0!==e.button)return;if(!e.target.closest(".slot"))return;if(this._pinch)return;if("touch"===e.pointerType){const t=performance.now(),i=void 0!==this._lastBarTap&&t-this._lastBarTap.time<400&&Math.abs(e.clientX-this._lastBarTap.x)<50;if(this._lastBarTap={time:t,x:e.clientX},!i)return void this._startBarPan(e)}this._createDrag={startClientX:e.clientX,ts0:this._clientXToTs(e.clientX),active:!1};const t=e=>{if(!this._createDrag)return;if(this._pinch)return this._createDrag=void 0,void(this._createRange=void 0);if(!this._createDrag.active&&Math.abs(e.clientX-this._createDrag.startClientX)<5)return;this._createDrag.active=!0;const t=this._clientXToTs(e.clientX),i=Math.min(this._createDrag.ts0,t),s=Math.max(this._createDrag.ts0,t);this._createRange={ts0:i,ts1:s}},i=()=>{window.removeEventListener("pointermove",t),window.removeEventListener("pointerup",i),window.removeEventListener("pointercancel",i);const e=this._createDrag;this._createDrag=void 0;const s=this._createRange;if(this._createRange=void 0,!(null==e?void 0:e.active)||!s)return;this._suppressNextClick=!0;const a=60*this._dragStepSize;s.ts1-s.ts0<a||this._commitCreate(s.ts0,s.ts1)};window.addEventListener("pointermove",t),window.addEventListener("pointerup",i),window.addEventListener("pointercancel",i)}_startBarPan(e){const t=e.clientX,i=this._panPx;let s=!1;const a=e=>{if(this._pinch)return;const a=e.clientX-t;!s&&Math.abs(a)<5||(s=!0,this._panPx=this._clampPan(i-a,this._zoom))},o=()=>{window.removeEventListener("pointermove",a),window.removeEventListener("pointerup",o),window.removeEventListener("pointercancel",o),s&&(this._suppressNextClick=!0)};window.addEventListener("pointermove",a),window.addEventListener("pointerup",o),window.addEventListener("pointercancel",o)}_commitCreate(e,t){const i=[...this.schedule.slots];this._pushUndo();let[s,a]=((e,t,i,s)=>{const a=e.map((t,i)=>{const a=Ee(t.start,s);let o;return void 0!==t.stop?(o=Ee(t.stop,s),!o&&a&&(o=86400)):o=i+1<e.length&&Ee(e[i+1].start,s)||86400,{start:a,stop:o}}),o=e.find((e,s)=>a[s].stop>t&&a[s].start<i)||e[0];let n=[],r=-1;return e.forEach((e,s)=>{const d=a[s];d.stop<=t?n.push(e):(-1===r&&(d.start<t&&n.push(Object.assign(Object.assign({},e),{stop:Va(t)})),r=n.length,n.push({start:Va(t),stop:Va(i),actions:[],conditions:o.conditions})),d.start>=i?n.push(e):d.stop>i&&n.push(Object.assign(Object.assign({},e),{start:Va(i)})))}),-1===r&&(r=n.length,n.push({start:Va(t),stop:Va(i),actions:[],conditions:o.conditions})),[n,r]})(i,e,t,this.hass);const o=[s[a-1],s[a+1]].find(e=>{var t;return(null===(t=null==e?void 0:e.actions)||void 0===t?void 0:t.length)&&null!==La(e.actions[0])}),n=o?La(o.actions[0]):null;n?(s=Object.assign([...s],{[a]:Object.assign(Object.assign({},s[a]),{actions:[n]})}),this.pendingSlot=null,this._slotsBackup=void 0):(this._slotsBackup=null!==this.pendingSlot&&this._slotsBackup?this._slotsBackup:i,this.pendingSlot=a),this.selectedSlot=a,this.schedule=Object.assign(Object.assign({},this.schedule),{slots:s}),this.dispatchEvent(new CustomEvent("update",{detail:{slots:s}})),this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:a}}))}_revertPendingSlot(e){const t=this._slotsBackup;let i=null;if(null!==e&&this.schedule.slots[e]){const s=Ee(this.schedule.slots[e].start,this.hass);i=t.findIndex((e,i)=>{const a=Ee(e.start,this.hass);let o=void 0!==e.stop?Ee(e.stop,this.hass)||86400:i+1<t.length?Ee(t[i+1].start,this.hass):86400;return s>=a&&s<o}),-1===i&&(i=null)}return this.pendingSlot=null,this._slotsBackup=void 0,this.schedule=Object.assign(Object.assign({},this.schedule),{slots:t}),this.dispatchEvent(new CustomEvent("update",{detail:{slots:t}})),i}willUpdate(){var e,t,i;null!==this.pendingSlot&&((null===(i=null===(t=null===(e=this.schedule)||void 0===e?void 0:e.slots[this.pendingSlot])||void 0===t?void 0:t.actions)||void 0===i?void 0:i.length)||0)>0&&(this.pendingSlot=null,this._slotsBackup=void 0)}render(){const e=Math.round(100*this._zoom),t=getComputedStyle(this).direction;return q`
    ...
    `}renderTimebar(){const e=De(this.hass.locale);return Wa(this._contentWidth,e).map(t=>{const i={mode:be.Fixed,hours:t.hour,minutes:0},s=Ne(i,{seconds:!1,am_pm:e}),a="left"===t.align?"left":"right"===t.align?"right":"";return q`
      ...
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{const a=i.actions.length?xs(i.actions[0],this.hass,this.config.customize,!0,!0):"",o=5*a.length+10,n=s>0?15:0,r=s<e.length-1?15:0,d=t[s]-n-r,l=e[s+1],c=i.actions.length?Ma(i.actions[0])?"off":Pa(i.actions[0])?"on":"":"",h=i.actions.length?Ha(i.actions[0]):null,u=h?{background:`rgba(${h.rgb.join(", ")}, ${h.alpha})`,border:this.selectedSlot==s?"3px solid rgb(var(--rgb-state-active-color, 67, 160, 71))":"2px solid rgba(var(--rgb-state-active-color, 67, 160, 71), 0.9)"}:{};return q`
        ...
        >
          ${i.stop,""}
          ${i.actions.length?a&&(d>o/3||d>50)&&d>30?q`<span style="margin-inline-start: ${n}px; margin-inline-end: ${r}px">${a}</span>`:d>16?q`<ha-icon icon="${Da(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
        ...
        `:""}
      `})}renderCreateOverlay(){if(!this._createRange)return"";const{ts0:e,ts1:t}=this._createRange,i=e/86400*this._contentWidth,s=(t-e)/86400*this._contentWidth,a=De(this.hass.locale),o=`${Ka(e,a)} - ${Ka(t,a)}`;return q`
      <div
    ...
    `}renderBoundaries(){if(!this._width)return q``;const e=this.schedule.slots,t=this.computeSlotWidths(),i=De(this.hass.locale),{boundaries:s,maxTier:a}=Ba(e,t,i,3,this.pendingSlot),o="rtl"===getComputedStyle(this).direction?"50%":"-50%";return q`
    ...
    `}computeSlotWidths(){return Ua(this.schedule.slots,this.hass,this._contentWidth)}_toggleSelectTimeslot(e){if(e.stopPropagation(),this._suppressNextClick)return void(this._suppressNextClick=!1);let t=e.target;"div"!=t.tagName.toLowerCase()&&(t=t.parentElement);let i=Number(t.getAttribute("idx"));if(null!==this.pendingSlot&&i!==this.pendingSlot&&!this.schedule.slots[this.pendingSlot].actions.length)return this.selectedSlot=this._revertPendingSlot(i),void this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:this.selectedSlot}}));this.selectedSlot=this.selectedSlot!==i?i:null;const s=new CustomEvent("update",{detail:{selectedSlot:this.selectedSlot}});this.dispatchEvent(s)}_handleDragStart(e){e.preventDefault(),e.stopPropagation(),this._pushUndo();let t=e.target;for(;"DIV"!==t.tagName;)t=t.parentElement;const i=t.parentElement.getBoundingClientRect(),s=Number(t.getAttribute("idx")),a=this._zoom>=4?1:this.config.time_step||15,o=60*a;let n=s>0?Ee(this.schedule.slots[s-1].stop||this.schedule.slots[s-1].start,this.hass)+o:o,r=(Ee(this.schedule.slots[s+1].stop||this.schedule.slots[s+1].start,this.hass)||86400)-o;void 0===this.schedule.slots[s+1].stop&&(r=(Ee(this.schedule.slots[s+2].stop||this.schedule.slots[s+2].start,this.hass)||86400)-o);const d=Ce(this.schedule.slots[s+1].start).mode;if([be.Sunrise,be.Sunset].includes(d)){let e=Ce(this.schedule.slots[s+1].start),t=Ee(Object.assign(Object.assign({},e),{hours:4,minutes:0}),this.hass),i=Ee(Object.assign(Object.assign({},e),{hours:-4,minutes:0}),this.hass);i>n&&(n=i),t<r&&(r=t)}let l=e=>{let t;e.preventDefault(),t="undefined"!=typeof TouchEvent&&e instanceof TouchEvent?e.changedTouches[0].pageX:e.pageX;t="rtl"===getComputedStyle(this).direction?i.right-(e instanceof TouchEvent?e.changedTouches[0].pageX:e.pageX):(e instanceof TouchEvent?e.changedTouches[0].pageX:e.pageX)-i.left,t>i.width&&(t=i.width),t<0&&(t=0);let o=Math.round(t/i.width*86400);o<n?o=n:o>r&&(o=r);const l=Math.floor(o/3600),c=Math.round((o-3600*l)/60);let h={mode:be.Fixed,hours:l,minutes:c};if([be.Sunrise,be.Sunset].includes(d)){const e=d==be.Sunrise?this.hass.states["sun.sun"].attributes.next_rising:this.hass.states["sun.sun"].attributes.next_setting,t=Za(h,e);h={mode:d,hours:t.hours,minutes:t.minutes}}h=ze(h,a);const u=Ne(h);let p=[...this.schedule.slots];if(p=Object.assign(p,{[s]:Object.assign(Object.assign({},p[s]),{stop:u}),[s+1]:Object.assign(Object.assign({},p[s+1]),{start:Ne(h)})}),void 0===p[s+1].stop){const e=Ne(Oe(h,{minutes:1}));p=Object.assign(p,{[s+2]:Object.assign(Object.assign({},p[s+2]),{start:e})})}this.schedule=Object.assign(Object.assign({},this.schedule),{slots:p});const m=new CustomEvent("update",{detail:{slots:p}});this.dispatchEvent(m)};const c=e=>{e.preventDefault()},h=()=>{window.removeEventListener("mousemove",l),window.removeEventListener("touchmove",l),window.removeEventListener("mouseup",h),window.removeEventListener("touchend",h),window.removeEventListener("blur",h),window.removeEventListener("dragstart",c),l=()=>{}};window.addEventListener("mouseup",h),window.addEventListener("touchend",h),window.addEventListener("blur",h),window.addEventListener("dragstart",c),window.addEventListener("mousemove",l),window.addEventListener("touchmove",l)}static get styles(){return r`
      :host {
        display: block;
        max-width: 100%;
        overflow: hidden;
    ...
    `}};t([le({attribute:!1})],Xa.prototype,"config",void 0),t([ce()],Xa.prototype,"schedule",void 0),t([ce()],Xa.prototype,"selectedSlot",void 0),t([ce()],Xa.prototype,"_width",void 0),t([ce()],Xa.prototype,"_zoom",void 0),t([ce()],Xa.prototype,"_panPx",void 0),t([ce()],Xa.prototype,"_createRange",void 0),t([ce()],Xa.prototype,"pendingSlot",void 0),t([le({type:Boolean})],Xa.prototype,"large",void 0),Xa=t([re("scheduler-timeslot-editor")],Xa);const Ya=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let Ja=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=be.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=Ce(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return q`
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return V;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=be.Fixed&&(e=Ya(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return q`
        <div class="mode">
  ...
  `,t([le({attribute:!1})],Ja.prototype,"hass",void 0),t([ce()],Ja.prototype,"hours",void 0),t([ce()],Ja.prototype,"minutes",void 0),t([ce()],Ja.prototype,"mode",void 0),t([le({type:Boolean})],Ja.prototype,"autoValidate",void 0),t([le({type:Boolean})],Ja.prototype,"required",void 0),t([le({type:Boolean})],Ja.prototype,"disabled",void 0),t([le({type:String})],Ja.prototype,"label",void 0),t([le({type:Boolean})],Ja.prototype,"useAmPm",void 0),t([le({type:Boolean})],Ja.prototype,"large",void 0),t([le({attribute:!1})],Ja.prototype,"stepSize",void 0),Ja=t([re("scheduler-time-picker")],Ja);let Ga=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![me.Daily,me.Weekend,me.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0&&this._params.weekdays.length==this.selectedWeekdays.length}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
    ...
    `:q``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[me.Sunday,me.Monday,me.Tuesday,me.Wednesday,me.Thursday,me.Friday,me.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,Os(this.hass))}else e=[me.Daily,me.Workday,me.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.some(e=>![me.Daily,me.Weekend,me.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>q`
        <ha-list-item
          graphic="icon"
        ...
        >
          ...
          ${"Custom"==e?q`
            ${is(Ki("ui.dialog.weekday_picker.choose",this.hass))}
      ...
      >
        <div slot="header">
          <ha-dialog-header>
            ...
            ${!this.lockDomain&&Ue(this._params.cardConfig.include)?q`
            <ha-dropdown
    ...
    ${this.schedule.entries.map((e,t)=>q`
      ...
      <div class="editor-header">
        ...
        <ha-button appearance="plain" size="small" @click=${this.toggleViewMode}>
          ${this.viewMode==pe.Scheme?Ki("ui.panel.editor.toggle_single_mode",this.hass):Ki("ui.panel.editor.toggle_scheme_mode",this.hass)}
    ...
    `}toggleViewMode(){const e=this.viewMode==pe.Scheme?pe.Single:pe.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return q``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Ee(e,this.hass),s=(Ee(t,this.hass)||86400)-i;return q`
      <div class="actions">
        <ha-icon-button .path=${qs} @click=${e=>{this._updateSelectedSlot(this.selectedSlot-1),e.target.blur()}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
    ...
    `}const n=cs(o,this.config.customize),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||Yi(o.service),d=Ue(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&Ue(null===(i=null===(t=cs(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return q``;const l=Object.keys(n.fields||{}).filter(e=>ba(o,e,this.hass,this.config.customize));let c="",h=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();!h.length&&["notify","script"].includes(r)&&(h=[o.service]),h.length&&(c+=h.map(e=>Es(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=xs(o,this.hass,this.config.customize,!1,!0);const u=null!==La(o);return q`
      ...
      >
        ...
        <div slot="content">
          ...
          ${l.map(e=>{var t;const i=_s(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let s=n.fields[e].optional||(i.number||{}).optional;const a=!s||Object.keys(o.service_data).includes(e);return q`
            <scheduler-settings-row ?showPrefix=${s}>
              ...
              `:""}
              <span slot="heading">
                ${((e,t,i,s)=>{var a;const o=Yi(e.service),n=Xi(e.service);let r=ss(`component.${o}.services.${n}.fields.${t}.name`,i,!1);!r&&i.services[o]&&i.services[o][e.service]&&i.services[o][e.service].fields&&i.services[o][e.service].fields[t]&&(r=String(i.services[o][e.service].fields[t].name));const d=["script","notify"].includes(o)?[e.service]:[(null===(a=e.target)||void 0===a?void 0:a.entity_id)||[]].flat(),l=d.length?d[0]:e.service;let c=ls(s||{},l);if(c.length){let i=c.map(i=>{if(i.service!=e.service||!Object.keys(i.variables||{}).includes(t))return null;return(i.variables||{})[t].name}).filter(Ue);if(i.length)return i[0]}return r||(r=t.replace(/_/g," ")),r})(o,e,this.hass,this.config.customize)}
              </span>
              <scheduler-combo-selector
                .hass=${this.hass}
                .config=${i}
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{var i;const s=this.conditionIdx==t?this.selectedEntity||e.entity_id||"":e.entity_id||"",a=this.conditionIdx==t&&this.selectedDomain||Yi(s),o=sa(s||a,this.hass,this.config.customize),n=o&&o.hasOwnProperty("number")?[ge.Above,ge.Below]:[ge.Equal,ge.Unequal],r={[ge.Equal]:"mdi:equal",[ge.Unequal]:"mdi:not-equal-variant",[ge.Above]:"mdi:greater-than",[ge.Below]:"mdi:less-than"},d={[ge.Equal]:"ui.panel.options.conditions.types.equal_to",[ge.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ge.Above]:"ui.panel.options.conditions.types.above",[ge.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=n[0]),q`
      <scheduler-collapsible-section idx="${t}">
        <div slot="header">
          ...
          ${is(Ki(d[e.match_type],this.hass,["{entity}","{value}"],[Es(e.entity_id,this.hass,this.config.customize)||"",null!==(i=us(e.value,o,this.hass))&&void 0!==i?i:""]))}
          `:Ki("ui.panel.options.conditions.add_condition",this.hass)}
        </div>
        <ha-dropdown
          slot="contextMenu"
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${is(Ki(d[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-dropdown
            ...
            >
              ...
              ${n.map(i=>q`
                ...
                >
                  ...
                  ${is(Ki(d[i],this.hass,["{entity}","{value}"],["",""]))}
                </ha-dropdown-item>
              `)}
            </ha-dropdown>
          </span>
...
/**
    ...
    `}catch(e){return q`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return q`
        ...
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return q`
          ...
          </div>`}return wo(e)};return As(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>q`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_toggleEnableDisable(e){const t=e.target.checked;this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
      ...
      >
        ...
        >
          <div class="content-inner">
            ...
            <div class="bar">
              ${t.map((e,s)=>{const a=e.actions.length?Ma(e.actions[0])?"off":Pa(e.actions[0])?"on":"":"empty",o=e.actions.length?Ha(e.actions[0]):null,n=t[s+1];return q`
                  <div
                    class="seg ${a} ${this.selectedSlot===s?"selected":""}"
                    style=${Gs(Object.assign({width:i[s]+"px"},o?{background:`rgba(${o.rgb.join(", ")}, ${o.alpha})`}:{}))}
                    @click=${e=>this._selectSlot(e,s)}
                  ></div>
    ...
    `}_selectSlot(e,t){e.stopPropagation(),this.selectedSlot=this.selectedSlot===t?null:t,null!==this.selectedSlot&&document.dispatchEvent(new CustomEvent(Eo,{detail:{source:this}}))}get _dragStepSize(){var e;return this.zoom>=4?1:(null===(e=this.config)||void 0===e?void 0:e.time_step)||15}_handleDragStart(e,t){e.preventDefault(),e.stopPropagation();const i=this._slots;if([be.Sunrise,be.Sunset].includes(Ce(i[t+1].start).mode))return;const s=this.shadowRoot.querySelector(".bar").getBoundingClientRect(),a=this._dragStepSize,o=60*a;let n=t>0?Ee(i[t-1].stop||i[t-1].start,this.hass)+o:o,r=(Ee(i[t+1].stop||i[t+1].start,this.hass)||86400)-o;void 0===i[t+1].stop&&(r=(Ee(i[t+2].stop||i[t+2].start,this.hass)||86400)-o);const d="rtl"===getComputedStyle(this).direction,l=e=>{e.preventDefault();const o=e instanceof TouchEvent?e.changedTouches[0].clientX:e.clientX;let l=d?s.right-o:o-s.left;l>s.width&&(l=s.width),l<0&&(l=0);let c=Math.round(l/s.width*86400);c<n?c=n:c>r&&(c=r);const h=Math.floor(c/3600),u=Math.round((c-3600*h)/60);let p={mode:be.Fixed,hours:h,minutes:u};p=ze(p,a);const m=Ne(p);let _=[...i];_=Object.assign(_,{[t]:Object.assign(Object.assign({},_[t]),{stop:m}),[t+1]:Object.assign(Object.assign({},_[t+1]),{start:m})}),this._liveSlots=_},c=()=>{window.removeEventListener("mousemove",l),window.removeEventListener("touchmove",l),window.removeEventListener("mouseup",c),window.removeEventListener("touchend",c),this._liveSlots&&this.dispatchEvent(new CustomEvent("slots-changed",{detail:{slots:this._liveSlots},bubbles:!0,composed:!0}))};window.addEventListener("mousemove",l),window.addEventListener("touchmove",l),window.addEventListener("mouseup",c),window.addEventListener("touchend",c)}static get styles(){return r`
      :host {
        display: block;
        width: 100%;
      }
    ...
    `}};t([le({attribute:!1})],Ao.prototype,"hass",void 0),t([le({attribute:!1})],Ao.prototype,"config",void 0),t([le({attribute:!1})],Ao.prototype,"slots",void 0),t([le({type:Number})],Ao.prototype,"zoom",void 0),t([le({type:Number})],Ao.prototype,"panPx",void 0),t([le({type:Number})],Ao.prototype,"viewportWidth",void 0),t([ce()],Ao.prototype,"selectedSlot",void 0),t([ce()],Ao.prototype,"_liveSlots",void 0),Ao=t([re("scheduler-overview-bar")],Ao);let To=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this._saveState=null}render(){var e,t,i;try{const s=this.hass.states[this.schedule.entity_id];if(!s)return q``;const a=["off","completed"].includes(s.state),{entry:o,index:n}=((e,t=new Date)=>{const i=Oo[t.getDay()],s=i===me.Friday||i===me.Saturday,a=e.findIndex(e=>e.weekdays.includes(i)),o=a>=0?a:e.findIndex(e=>s?e.weekdays.includes(me.Weekend):e.weekdays.includes(me.Workday)),n=o>=0?o:e.findIndex(e=>e.weekdays.includes(me.Daily)),r=n>=0?n:0;return{entry:e[r],index:r}})(this.schedule.entries,this.date),r=null===(e=o.slots.find(e=>e.actions.length))||void 0===e?void 0:e.actions[0];let d="mdi:calendar-clock";if(r){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Yi(r.service))&&(e=r.service),e&&(d=oa(e,this.config.customize,this.hass))}const l=r?Es(["script","notify"].includes(Yi(r.service))?r.service:[(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat()[0]||"",this.hass,this.config.customize):this.schedule.name||this.schedule.entity_id;return q`
      ...
      >
        ...
        >
          <div class="ruler" style=${Gs({width:this._contentWidth+"px",transform:`translateX(${-this.panPx}px)`})}>
            ${t.map(t=>{const i={mode:be.Fixed,hours:t.hour,minutes:0},a=Ne(i,{seconds:!1,am_pm:e}),o="left"===t.align?"left":"right"===t.align?"right":"",n=t.hour===s||0===t.hour&&24===s;return q`
    ...
    ${this.overviewMode&&!this.connectionError&&Object.keys(t).length?q`

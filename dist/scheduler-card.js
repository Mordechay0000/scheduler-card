...
/**
    ...
    `}};t([le({attribute:!1})],To.prototype,"hass",void 0),t([le({attribute:!1})],To.prototype,"config",void 0),t([le({attribute:!1})],To.prototype,"slots",void 0),t([le({type:Number})],To.prototype,"zoom",void 0),t([le({type:Number})],To.prototype,"panPx",void 0),t([le({type:Number})],To.prototype,"viewportWidth",void 0),t([ce()],To.prototype,"selectedSlot",void 0),t([ce()],To.prototype,"_liveSlots",void 0),t([ce()],To.prototype,"_createRange",void 0),To=t([re("scheduler-overview-bar")],To);let Do=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this._saveState=null}render(){var e,t,i;try{const s=this.hass.states[this.schedule.entity_id];if(!s)return R``;const a=["off","completed"].includes(s.state),{entry:o,index:n}=((e,t=new Date)=>{const i=zo[t.getDay()],s=i===me.Friday||i===me.Saturday,a=e.findIndex(e=>e.weekdays.includes(i)),o=a>=0?a:e.findIndex(e=>s?e.weekdays.includes(me.Weekend):e.weekdays.includes(me.Workday)),n=o>=0?o:e.findIndex(e=>e.weekdays.includes(me.Daily)),r=n>=0?n:0;return{entry:e[r],index:r}})(this.schedule.entries,this.date),r=null===(e=o.slots.find(e=>e.actions.length))||void 0===e?void 0:e.actions[0];let d="mdi:calendar-clock";if(r){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Yi(r.service))&&(e=r.service),e&&(d=oa(e,this.config.customize,this.hass))}const l=r?Es(["script","notify"].includes(Yi(r.service))?r.service:[(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat()[0]||"",this.hass,this.config.customize):this.schedule.name||this.schedule.entity_id;return R`
      ...
      `}catch(e){return R``}}_handleToggle(e){e.stopPropagation();const t=this.hass.states[this.schedule.entity_id];if(!t)return;const i=["off","completed"].includes(t.state);this.hass.callService("switch",i?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}_handleEditClick(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}}))}_handleSlotsChanged(e,t){e.stopPropagation(),this._undoSlots=this.schedule.entries[t].slots,this._undoEntryIndex=t,Eo(()=>this._performUndo()),this._showSaved(),this._saveAndSet(t,e.detail.slots)}_saveAndSet(e,t){const i=Object.assign([...this.schedule.entries],{[e]:Object.assign(Object.assign({},this.schedule.entries[e]),{slots:t})}),s=Object.assign(Object.assign({},this.schedule),{entries:i});this.schedule=s,this.dispatchEvent(new CustomEvent("scheduleChanged",{detail:{schedule:s}})),Promise.resolve(xa(this.hass,s)).catch(e=>{console.error("scheduler-card: could not save schedule",e),this._saveState=null})}_showSaved(){clearTimeout(this._saveStateTimer),this._saveState="saved",this._saveStateTimer=window.setTimeout(()=>{this._saveState="reset"},2500)}_handlePillClick(){"reset"===this._saveState&&this._performUndo()}_performUndo(){void 0!==this._undoSlots&&void 0!==this._undoEntryIndex&&(this._saveAndSet(this._undoEntryIndex,this._undoSlots),this._undoSlots=void 0,this._undoEntryIndex=void 0,Eo(null),clearTimeout(this._saveStateTimer),this._saveState=null)}static get styles(){return r`
      :host {
        display: block;
      }
      .row {

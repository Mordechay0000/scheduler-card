...
/**
    ...
    `}};t([le()],So.prototype,"hass",void 0),t([le()],So.prototype,"schedule_id",void 0),t([le()],So.prototype,"schedule",void 0),t([le()],So.prototype,"config",void 0),So=t([re("scheduler-item-row")],So);const Oo=[me.Sunday,me.Monday,me.Tuesday,me.Wednesday,me.Thursday,me.Friday,me.Saturday];let zo=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this.selectedSlot=null}get _slots(){return this._liveSlots||this.slots}get _contentWidth(){return this.viewportWidth*this.zoom}updated(e){var t;e.has("slots")&&(this._liveSlots=void 0);const i=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(".content-inner");i&&(i.style.direction=getComputedStyle(this).direction)}render(){var e;if(!this.hass||!(null===(e=this.slots)||void 0===e?void 0:e.length)||!this.viewportWidth)return q``;const t=this._slots,i=Ua(t,this.hass,this._contentWidth,2),s=De(this.hass.locale),{boundaries:a,maxTier:o}=Ba(t,i,s,2),n="rtl"===getComputedStyle(this).direction?"50%":"-50%",r=15+13*o;return q`
      <div class="viewport">
        <div
          class="zoom-content"
    ...
    `}};t([le({attribute:!1})],zo.prototype,"hass",void 0),t([le({attribute:!1})],zo.prototype,"config",void 0),t([le({attribute:!1})],zo.prototype,"slots",void 0),t([le({type:Number})],zo.prototype,"zoom",void 0),t([le({type:Number})],zo.prototype,"panPx",void 0),t([le({type:Number})],zo.prototype,"viewportWidth",void 0),t([ce()],zo.prototype,"selectedSlot",void 0),t([ce()],zo.prototype,"_liveSlots",void 0),zo=t([re("scheduler-overview-bar")],zo);let Co=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0}render(){var e,t,i;try{const s=this.hass.states[this.schedule.entity_id];if(!s)return q``;const a=["off","completed"].includes(s.state),{entry:o,index:n}=((e,t=new Date)=>{const i=Oo[t.getDay()],s=i===me.Friday||i===me.Saturday,a=e.findIndex(e=>e.weekdays.includes(i)),o=a>=0?a:e.findIndex(e=>s?e.weekdays.includes(me.Weekend):e.weekdays.includes(me.Workday)),n=o>=0?o:e.findIndex(e=>e.weekdays.includes(me.Daily)),r=n>=0?n:0;return{entry:e[r],index:r}})(this.schedule.entries,this.date),r=null===(e=o.slots.find(e=>e.actions.length))||void 0===e?void 0:e.actions[0];let d="mdi:calendar-clock";if(r){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Yi(r.service))&&(e=r.service),e&&(d=oa(e,this.config.customize,this.hass))}const l=r?Es(["script","notify"].includes(Yi(r.service))?r.service:[(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat()[0]||"",this.hass,this.config.customize):this.schedule.name||this.schedule.entity_id;return q`
      ...
      `}catch(e){return q``}}_handleToggle(e){e.stopPropagation();const t=this.hass.states[this.schedule.entity_id];if(!t)return;const i=["off","completed"].includes(t.state);this.hass.callService("switch",i?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}_handleSlotsChanged(e,t){e.stopPropagation();const i=e.detail.slots,s=Object.assign([...this.schedule.entries],{[t]:Object.assign(Object.assign({},this.schedule.entries[t]),{slots:i})}),a=Object.assign(Object.assign({},this.schedule),{entries:s});xa(this.hass,a),this.dispatchEvent(new CustomEvent("scheduleChanged",{detail:{schedule:a}}))}static get styles(){return r`
      :host {
        display: block;
      }
      .row {
    ...
    `}};t([le()],Co.prototype,"hass",void 0),t([le()],Co.prototype,"schedule_id",void 0),t([le()],Co.prototype,"schedule",void 0),t([le()],Co.prototype,"config",void 0),t([le({attribute:!1})],Co.prototype,"date",void 0),t([le({type:Number})],Co.prototype,"zoom",void 0),t([le({type:Number})],Co.prototype,"panPx",void 0),t([le({type:Number})],Co.prototype,"viewportWidth",void 0),Co=t([re("scheduler-overview-row")],Co);let Eo=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.minZoom=1,this.maxZoom=48,this._width=0}get _contentWidth(){return this._width*this.zoom}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=Math.max(0,t.contentRect.width-158);e!==this._width&&(this._width=e,this.dispatchEvent(new CustomEvent("viewport-width-changed",{detail:{width:e},bubbles:!0,composed:!0})))}}),this._resizeObserver.observe(this)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._resizeObserver)||void 0===e||e.disconnect()}_fireZoom(e){this.dispatchEvent(new CustomEvent("overview-zoom",{detail:e,bubbles:!0,composed:!0}))}_fireReset(){this.dispatchEvent(new CustomEvent("overview-zoom-reset",{bubbles:!0,composed:!0}))}_handleWheel(e){if(!this._width)return;const t=e.ctrlKey||e.metaKey||Math.abs(e.deltaY)>=Math.abs(e.deltaX);e.preventDefault();const i=e.currentTarget.getBoundingClientRect(),s=e.clientX-i.left;if(t){const t=Math.pow(2,-e.deltaY/300);this._fireZoom({anchorPx:s,factor:t})}else this.dispatchEvent(new CustomEvent("overview-pan",{detail:{deltaPx:e.deltaX},bubbles:!0,composed:!0}))}_handlePanStart(e){this.zoom<=this.minZoom||(e.currentTarget.setPointerCapture(e.pointerId),this._panDrag={pointerId:e.pointerId,startX:e.clientX})}_handlePanMove(e){if(!this._panDrag||this._panDrag.pointerId!==e.pointerId)return;const t=e.clientX-this._panDrag.startX;this._panDrag.startX=e.clientX,this.dispatchEvent(new CustomEvent("overview-pan",{detail:{deltaPx:-t},bubbles:!0,composed:!0}))}_handlePanEnd(){this._panDrag=void 0}_touchDistance(e){const t=e[0].clientX-e[1].clientX,i=e[0].clientY-e[1].clientY;return Math.hypot(t,i)}_handlePinchStart(e){if(2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect();this._pinch={distance:this._touchDistance(e.touches),midpointX:(e.touches[0].clientX+e.touches[1].clientX)/2-t.left-158}}_handlePinchMove(e){if(!this._pinch||2!==e.touches.length)return;e.preventDefault();const t=this._touchDistance(e.touches),i=t/this._pinch.distance;this._fireZoom({anchorPx:this._pinch.midpointX,factor:i}),this._pinch.distance=t}_handlePinchEnd(e){e.touches.length<2&&(this._pinch=void 0)}render(){if(!this.hass)return q``;const e=De(this.hass.locale),t=Wa(this._contentWidth,e),i=Math.round(100*this.zoom);return q`
      <div class="zoom-controls">
        <ha-icon-button
          .disabled=${this.zoom<=this.minZoom}
          @click=${()=>this._fireZoom({anchorPx:this._width/2,factor:.625,animate:!0})}
        >
          <ha-icon icon="mdi:magnify-minus-outline"></ha-icon>
        </ha-icon-button>
        ...
        <ha-icon-button
          ...
          @click=${()=>this._fireZoom({anchorPx:this._width/2,factor:1.6,animate:!0})}
        >
          <ha-icon icon="mdi:magnify-plus-outline"></ha-icon>
        </ha-icon-button>
      </div>
      ...
      >
        ...
        >
          <div class="ruler" style=${Gs({width:this._contentWidth+"px",transform:`translateX(${-this.panPx}px)`})}>
            ${t.map(t=>{const i={mode:be.Fixed,hours:t.hour,minutes:0},s=Ne(i,{seconds:!1,am_pm:e}),a="left"===t.align?"left":"right"===t.align?"right":"";return q`
                <span class="${a}" style=${Gs({width:t.widthPct+"%"})}>${s}</span>
              `})}
          </div>
        </div>
